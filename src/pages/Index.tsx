    ...
    <div className="min-h-screen cursor-none">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex gap-4 flex-wrap justify-center lg:justify-start animate-fade-slide-up-delay-4">
              {[
                ...
                <div
                  key={label}
                  className="bg-white/[0.04] border border-border rounded-xl px-5 py-3.5 text-center backdrop-blur-sm hover:border-primary/40 hover:-translate-y-1 transition-all duration-300"
                >
      ...
      <footer className="relative z-[2] border-t border-border px-12 py-7 flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex gap-5">
          {["Home", "History", "Features", "About", "Session"].map((item) => (
            <a
              key={item}
